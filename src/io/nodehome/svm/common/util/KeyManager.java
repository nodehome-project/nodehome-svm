...
public class KeyManager {
	...
	public static void reloadManagerKey() {
		sm_memKeys[2] = loadPrivateKey(NetConfig.defaultNet, KEY_FILE_PATH + "man200_"+NetConfig.defaultNet.getNetName()+".key");
		sm_memKeys[3] = loadPrivateKey(NetConfig.defaultNet, KEY_FILE_PATH + "man300_"+NetConfig.defaultNet.getNetName()+".key");
	}
